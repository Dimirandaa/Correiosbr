...
public class ResultadoBuscaPage {
	...
	By bairroDistrito = By.xpath("//td[@data-th='Bairro/Distrito']");
	By localidadeUF = By.xpath("//td[@data-th='Localidade/UF']");
	By cep = By.xpath("//td[@data-th='CEP']");

	public void validarBuscarCepEndereco(String logradouroNome, String bairroDistrito, String localidadeUF,
			String cep) {
